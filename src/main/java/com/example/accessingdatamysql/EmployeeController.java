...
import com.portal.company.services.EmployeeService;
...
//	}
    ...
    public String deleteEmployee(@RequestParam long id, Model model) {
        System.out.println("Inside the delete employee controller method");

        // Implement logic to delete the employee with the given id using the repository
	...
	public String processUpdateProfile(@RequestParam long id, @ModelAttribute Employee updatedEmployee, Model model) {
	    ...
	    if (existingEmployeeData.isPresent()) {
	        ...
	        existingEmployee.setdepName(updatedEmployee.getdepName());
